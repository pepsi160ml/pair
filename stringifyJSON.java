...
public class stringifyJSON {
  ...
  public String stringify(Object data) {
    ...
    //입력된 값이 Object[]일 경우
              ...
              Object[] arr = (Object[]) data;//타입을 배열로바꾼(강제로) 데이터가 arr배열에 들어감
    ...
    //입력된 값이 HashMap일 경우
          ...
          HashMap<Object, Object> map1 = (HashMap<Object, Object>)data;
          HashMap<Object, Object> map2 = new LinkedHashMap<>();
          for(Map.Entry<Object, Object> entry : map1.entrySet()){

              key = stringify(entry.getKey());
              value = stringify(entry.getValue());
              map2.put(key, value);
          }
          String str = map2.toString().replace("=", ":").replace(" ", "");
          return str;
            }
